...
define('CRM_HOST', 'b24-8q153g.bitrix24.ru'); // your CRM domain name
define('CRM_PORT', '443'); // CRM server port
define('CRM_PATH', '/crm/configs/import/lead.php'); // CRM server REST service path

// CRM server authorization data
define('CRM_LOGIN', 'marchenkoiuliia@icloud.com'); // login of a CRM user able to manage leads
define('CRM_PASSWORD', 'sjmBnYq9TK'); // password of a CRM user
